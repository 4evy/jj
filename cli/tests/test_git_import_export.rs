...
fn test_git_export_undo() -> TestResult {
    ...
    insta::assert_snapshot!(output, @"
    ------- stderr -------
    Undid operation: 6a6e988ce4c8 (2001-02-03 08:05:10) export git refs
    Restored to operation: 9aa26c790d9f (2001-02-03 08:05:08) create bookmark a pointing to commit e8849ae12c709f2321908879bc724fdb2ab8a781
    [EOF]
    ");
...
fn test_git_import_undo() -> TestResult {
    ...
    insta::assert_snapshot!(output, @"
    ------- stderr -------
    Restored to operation: 3366dbbb81ac (2001-02-03 08:05:07) add workspace 'default'
    [EOF]
    ");
    insta::assert_snapshot!(get_bookmark_output(&work_dir), @"");
