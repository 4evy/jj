...
fn test_duplicate() {
    ...
    insta::assert_snapshot!(output, @"
    ------- stderr -------
    Undid operation: 3508578f4e4a (2001-02-03 08:05:17) duplicate 1 commit(s)
    Restored to operation: 6627db13e9e4 (2001-02-03 08:05:13) create bookmark c pointing to commit 387b928721d9f2efff819ccce81868f32537d71f
    [EOF]
    ");
...
fn test_undo_after_duplicate() {
    ...
    insta::assert_snapshot!(output, @"
    ------- stderr -------
    Undid operation: f45e1196a92f (2001-02-03 08:05:11) duplicate 1 commit(s)
    Restored to operation: 16bd6d579c74 (2001-02-03 08:05:09) create bookmark a pointing to commit 7d980be7a1d499e4d316ab4c01242885032f7eaf
    [EOF]
    ");
    insta::assert_snapshot!(get_log_output(&work_dir), @"
    @  7d980be7a1d4   a
